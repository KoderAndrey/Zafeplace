...
import com.zafeplace.sdk.stellarsdk.sdk.xdr.Int64;
import com.zafeplace.sdk.stellarsdk.sdk.xdr.OperationType;
import com.zafeplace.sdk.stellarsdk.sdk.xdr.PathPaymentOp;
...
public class PathPaymentOperation extends Operation {
    ...
    com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody toOperationBody() {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.PathPaymentOp op = new com.zafeplace.sdk.stellarsdk.sdk.xdr.PathPaymentOp();

        // sendAsset
        op.setSendAsset(sendAsset.toXdr());
        // sendMax
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Int64 sendMax = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Int64();
        ...
        // path
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Asset[] path = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Asset[this.path.length];
