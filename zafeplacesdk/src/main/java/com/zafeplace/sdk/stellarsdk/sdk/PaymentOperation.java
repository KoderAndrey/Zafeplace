...
import com.zafeplace.sdk.stellarsdk.sdk.xdr.PaymentOp;
...
public class PaymentOperation extends Operation {
  ...
  @Override
    com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody toOperationBody() {
      com.zafeplace.sdk.stellarsdk.sdk.xdr.PaymentOp op = new com.zafeplace.sdk.stellarsdk.sdk.xdr.PaymentOp();

    // destination
      com.zafeplace.sdk.stellarsdk.sdk.xdr.AccountID destination = new com.zafeplace.sdk.stellarsdk.sdk.xdr.AccountID();
