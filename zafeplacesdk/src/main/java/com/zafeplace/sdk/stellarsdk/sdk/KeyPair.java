...
public class KeyPair {
    ...
    public com.zafeplace.sdk.stellarsdk.sdk.xdr.SignatureHint getSignatureHint() {
        try {
            ByteArrayOutputStream publicKeyBytesStream = new ByteArrayOutputStream();
            com.zafeplace.sdk.stellarsdk.sdk.xdr.XdrDataOutputStream xdrOutputStream = new com.zafeplace.sdk.stellarsdk.sdk.xdr.XdrDataOutputStream(publicKeyBytesStream);
            com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKey.encode(xdrOutputStream, this.getXdrPublicKey());
            ...
            com.zafeplace.sdk.stellarsdk.sdk.xdr.SignatureHint signatureHint = new com.zafeplace.sdk.stellarsdk.sdk.xdr.SignatureHint();
    ...
    public com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKey getXdrPublicKey() {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKey publicKey = new com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKey();
        publicKey.setDiscriminant(com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKeyType.PUBLIC_KEY_TYPE_ED25519);
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Uint256 uint256 = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Uint256();
        uint256.setUint256(getPublicKey());
        publicKey.setEd25519(uint256);
        return publicKey;
    }

    public com.zafeplace.sdk.stellarsdk.sdk.xdr.SignerKey getXdrSignerKey() {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.SignerKey signerKey = new com.zafeplace.sdk.stellarsdk.sdk.xdr.SignerKey();
        signerKey.setDiscriminant(com.zafeplace.sdk.stellarsdk.sdk.xdr.SignerKeyType.SIGNER_KEY_TYPE_ED25519);
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Uint256 uint256 = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Uint256();
        uint256.setUint256(getPublicKey());
    ...
    public static KeyPair fromXdrPublicKey(com.zafeplace.sdk.stellarsdk.sdk.xdr.PublicKey key) {
        return KeyPair.fromPublicKey(key.getEd25519().getUint256());
    }

    public static KeyPair fromXdrSignerKey(com.zafeplace.sdk.stellarsdk.sdk.xdr.SignerKey key) {
        return KeyPair.fromPublicKey(key.getEd25519().getUint256());
    }
     ...
     * @param data
     */
    public com.zafeplace.sdk.stellarsdk.sdk.xdr.DecoratedSignature signDecorated(byte[] data) {
        ...
        com.zafeplace.sdk.stellarsdk.sdk.xdr.DecoratedSignature decoratedSignature = new com.zafeplace.sdk.stellarsdk.sdk.xdr.DecoratedSignature();
