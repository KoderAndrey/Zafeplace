...
import com.zafeplace.sdk.stellarsdk.sdk.xdr.Int32;
...
public class Price {
     ...
     */
    public com.zafeplace.sdk.stellarsdk.sdk.xdr.Price toXdr() {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Price xdr = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Price();
        Int32 n = new Int32();
        Int32 d = new Int32();
        n.setInt32(this.n);
        d.setInt32(this.d);
