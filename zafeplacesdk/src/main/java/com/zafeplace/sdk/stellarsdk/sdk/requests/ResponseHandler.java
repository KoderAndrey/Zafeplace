...
import com.zafeplace.sdk.stellarsdk.sdk.responses.GsonSingleton;
import com.zafeplace.sdk.stellarsdk.sdk.responses.TypedResponse;
...
public class ResponseHandler<T> {
  ...
  public T handleResponse(final Response response) throws IOException, TooManyRequestsException {
    try {
      ...
      if (object instanceof com.zafeplace.sdk.stellarsdk.sdk.responses.Response) {
        ((com.zafeplace.sdk.stellarsdk.sdk.responses.Response) object).setHeaders(response.headers());
      }
