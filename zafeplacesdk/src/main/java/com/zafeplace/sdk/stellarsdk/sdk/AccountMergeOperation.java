...
import com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody;
...
public class AccountMergeOperation extends Operation {
    ...
    OperationBody toOperationBody() {
        OperationBody body = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody();
