...
public class StellarMessage {
    ...
    private com.zafeplace.sdk.stellarsdk.sdk.xdr.Error error;

    public com.zafeplace.sdk.stellarsdk.sdk.xdr.Error getError() {
        return this.error;
    }

    public void setError(com.zafeplace.sdk.stellarsdk.sdk.xdr.Error value) {
        this.error = value;
    }
    ...
    public static void encode(XdrDataOutputStream stream, StellarMessage encodedStellarMessage) throws IOException {
        ...
        switch (encodedStellarMessage.getDiscriminant()) {
            case ERROR_MSG:
                com.zafeplace.sdk.stellarsdk.sdk.xdr.Error.encode(stream, encodedStellarMessage.error);
                break;
            case HELLO:
