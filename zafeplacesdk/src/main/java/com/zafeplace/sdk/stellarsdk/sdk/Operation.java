...
public abstract class Operation {
     ...
     */
    public com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation toXdr() {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation xdr = new com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation();
    ...
    public String toXdrBase64() {
        try {
            com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation operation = this.toXdr();
            ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
            com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.encode(xdrOutputStream, operation);
     ...
     */
    public static Operation fromXdr(com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation xdr) {
        com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody body = xdr.getBody();
       Operation operation;
     ...
     */
    abstract com.zafeplace.sdk.stellarsdk.sdk.xdr.Operation.OperationBody toOperationBody();
}
